...
function openPromoModal() {
    if (window.pageYOffset > 1000 && !isShown) {
        drawNotification({
            ...
            `,
            html: `
                    <p class="main text">Refer a friend and both of you will enjoy 10% off your next haircut.
                        <span class="linebreak"> It's our way of saying thanks for spreading the word.</span>
                    </p>
